if (function(a) {
        ...
        var c = 0,
            d = /https?:\/\/(?:[0-9A-Z-]+\.)?(?:youtu\.be\/|youtube\.com\S*[^\w\-\s])([\w\-]{11})(?=[^\w\-]|$)(?![?=&+%\w.\-]*(?:['"][^<>]*>|<\/a>))[?=&+%\w.-]*/gi,
        ...
        a.fn.redactor = function(c) {
        ...
        }, a.Redactor = b, a.Redactor.VERSION = "10.0.9", a.Redactor.modules = ["alignment", "autosave", "block", "buffer", "build", "button", "caret", "clean", "code", "core", "dropdown", "file", "focus", "image", "indent", "inline", "insert", "keydown", "keyup", "lang", "line", "link", "list", "modal", "observe", "paragraphize", "paste", "placeholder", "progress", "selection", "shortcuts", "tabifier", "tidy", "toolbar", "upload", "utils"], a.Redactor.opts = {
            lang: "en",
            direction: "ltr",
            plugins: !1,
            focus: !1,
            ...
            autosave: function() {
                return {
                    enable: function() {
                        this.opts.autosave && (this.autosave.html = !1, this.autosave.name = this.opts.autosaveName ? this.opts.autosaveName : this.$textarea.attr("name"), this.opts.autosaveOnChange || (this.autosaveInterval = setInterval(this.autosave.load, 1e3 * this.opts.autosaveInterval)))
                    },
                    onChange: function() {
                        this.opts.autosaveOnChange && this.autosave.load()
                    },
                    load: function() {
                        if (this.autosave.source = this.code.get(), this.autosave.html !== this.autosave.source && !this.utils.isEmpty(this.autosave.source)) {
                            var b = {};
                ...
                return {
                    ...
                    setCollapsed: function(b) {
                        ...
                        if (c !== !1) {
                            ...
                            var d = "TD" == this.block.containerTag || "TH" == this.block.containerTag;
                            if (d && !this.opts.linebreaks) document.execCommand("formatblock", !1, "<" + b + ">"), c = this.selection.getBlock(), this.block.toggle(a(c));
                            else if (c.tagName.toLowerCase() != b)
                                if (this.opts.linebreaks && "p" == b) a(c).prepend("<br>").append("<br>"), this.utils.replaceWithContents(c);
                                else {
                                    var e = this.utils.replaceToTag(c, b);
                                    this.block.toggle(e), "p" != b && "blockquote" != b && e.find("img").remove(), this.block.isRemoveInline && this.utils.removeInlineTags(e), ("p" == b || this.block.headTag) && e.find("p").contents().unwrap(), this.block.formatTableWrapping(e)
                                } else if ("blockquote" == b && c.tagName.toLowerCase() == b)
                                if (this.opts.linebreaks) a(c).prepend("<br>").append("<br>"), this.utils.replaceWithContents(c);
                                else {
                                    var f = this.utils.replaceToTag(c, "p");
                                    this.block.toggle(f)
                                } else c.tagName.toLowerCase() == b && this.block.toggle(a(c));
                            "undefined" == typeof this.block.type && "undefined" == typeof this.block.value && a(c).removeAttr("class").removeAttr("style")
                        }
                    },
                    ...
                    formatListToBlockquote: function() {
                        var b = a(this.block.blocks[0]).closest("ul, ol");
            ...
            build: function() {
                return {
                    ...
                    createContainerBox: function() {
                        this.$box = a('<div class="redactor-box" />')
                    },
                    ...
                    callEditor: function() {
                        this.build.disableMozillaEditing(), this.build.setEvents(), this.build.setHelpers(), this.opts.toolbar && (this.opts.toolbar = this.toolbar.init(), this.toolbar.build()), this.modal.loadTemplates(), this.build.plugins(), setTimeout(a.proxy(this.observe.load, this), 4), this.core.setCallback("init")
                    },
                    setOptions: function() {
                    ...
                    setEvents: function() {
                        ...
                        }, this)), this.$editor.on("paste.redactor", a.proxy(this.paste.init, this)), this.$editor.on("keydown.redactor", a.proxy(this.keydown.init, this)), this.$editor.on("keyup.redactor", a.proxy(this.keyup.init, this)), a.isFunction(this.opts.codeKeydownCallback) && this.$textarea.on("keydown.redactor-textarea", a.proxy(this.opts.codeKeydownCallback, this)), a.isFunction(this.opts.codeKeyupCallback) && this.$textarea.on("keyup.redactor-textarea", a.proxy(this.opts.codeKeyupCallback, this)), a.isFunction(this.opts.focusCallback) && this.$editor.on("focus.redactor", a.proxy(this.opts.focusCallback, this));
                        var b;
                        a(document).on("mousedown", function(a) {
                            b = a.target
                        }), this.$editor.on("blur.redactor", a.proxy(function(c) {
                            this.rtePaste || this.build.isBlured(b) && (this.utils.disableSelectAll(), a.isFunction(this.opts.blurCallback) && this.core.setCallback("blur", c))
                        }, this))
                    },
                    isBlured: function(b) {
                        var c = a(b);
                        return !c.hasClass("redactor-toolbar, redactor-dropdown") && !c.is("#redactor-modal") && 0 === c.parents(".redactor-toolbar, .redactor-dropdown, #redactor-modal").length
                    },
                    setHelpers: function() {
                        this.autosave.enable(), this.placeholder.enable(), this.opts.focus && setTimeout(this.focus.setStart, 100), this.opts.focusEnd && setTimeout(this.focus.setEnd, 100)
                    },
                    plugins: function() {
                        this.opts.plugins && RedactorPlugins && a.each(this.opts.plugins, a.proxy(function(b, c) {
                            if ("undefined" != typeof RedactorPlugins[c]) {
                                if (-1 !== a.inArray(c, a.Redactor.modules)) return void a.error('Plugin name "' + c + "\" matches the name of the Redactor's module.");
                                if (a.isFunction(RedactorPlugins[c])) {
                                    this[c] = RedactorPlugins[c]();
                                    for (var d = this.getModuleMethods(this[c]), e = d.length, f = 0; e > f; f++) this[c][d[f]] = this[c][d[f]].bind(this);
                                    a.isFunction(this[c].init) && this[c].init()
                                }
                            }
                        }, this))
                    },
            ...
            button: function() {
                return {
                    ...
                    createTooltip: function(b, c, d) {
                        var e = a("<span>").addClass("redactor-toolbar-tooltip redactor-toolbar-tooltip-" + c).hide().html(d);
                    ...
                    onClickCallback: function(b, c, d) {
                        var e;
                        if (a.isFunction(c)) c.call(this, d);
                        else if ("-1" != c.search(/\./)) {
                ...
                return {
                    ...
                    setOffset: function(a, b) {
                        ...
                        for (var c, d = (this.selection.get(), 0), e = document.createTreeWalker(this.$editor[0], NodeFilter.SHOW_TEXT, null, null); c = e.nextNode();)
                            if (d += c.nodeValue.length, d > a && (this.range.setStart(c, c.nodeValue.length + a - d), a = 1 / 0), d >= b) {
            ...
            clean: function() {
                return {
                    onSet: function(b) {
                        b = this.clean.savePreCode(b), b = b.replace(/<script(.*?[^>]?)>([\w\W]*?)<\/script>/gi, '<pre class="redactor-script-tag" style="display: none;" $1>$2</pre>'), b = b.replace(/\$/g, "&#36;"), b = b.replace(/<a href="(.*?[^>]?)Ã‚Â®(.*?[^>]?)">/gi, '<a href="$1&reg$2">'), this.opts.replaceDivs && (b = this.clean.replaceDivs(b)), this.opts.linebreaks && (b = this.clean.replaceParagraphsToBr(b)), b = this.clean.saveFormTags(b);
                        var c = a("<div>");
                        c.html(b);
                        ...
                        }), b = c.html()), c.remove(), b = b.replace(/<font(.*?[^<])>/gi, ""), b = b.replace(/<\/font>/gi, ""), b = this.tidy.load(b), this.opts.paragraphize && (b = this.paragraphize.load(b)), b = this.clean.setVerified(b), b = this.clean.convertInline(b)
                    },
                    onSync: function(b) {
                        ...
                        return a.each(c, function(a, c) {
                            ...
                            }), b = b.replace(new RegExp("<br\\s?/?></li>", "gi"), "</li>"), b = b.replace(new RegExp("</li><br\\s?/?>", "gi"), "</li>"),
                    ...
                    onPaste: function(b, c) {
                        if (b = a.trim(b), b = b.replace(/\$/g, "&#36;"), b = b.replace(/<span class="s1">/gi, "<span>"), b = b.replace(/<span class="Apple-converted-space">&nbsp;<\/span>/gi, " "), b = b.replace(/<span class="Apple-tab-span"[^>]*>\t<\/span>/gi, "	"), b = b.replace(/<span[^>]*>(\s|&nbsp;)<\/span>/gi, " "), this.opts.pastePlainText) return this.clean.getPlainText(b);
                        if (!this.utils.isSelectAll() && "undefined" == typeof c) {
                            ...
                            if (this.utils.isCurrentOrParent("PRE")) return b = b.replace(/Ã¢â‚¬Â/g, '"'), b = b.replace(/Ã¢â‚¬Å“/g, '"'), b = b.replace(/Ã¢â‚¬Ëœ/g, "'"), b = b.replace(/Ã¢â‚¬â„¢/g, "'"), this.clean.getPreCode(b);
                    ...
                    onPasteTidy: function(a, b) {
                        ...
                        return this.opts.deniedTags && (f.deniedTags = this.opts.deniedTags), this.opts.allowedTags && (f.allowedTags = this.opts.allowedTags), this.tidy.load(a, f)
                    },
                        ...
                        if (this.clean.singleLine = !1, !this.utils.isSelectAll() && "undefined" == typeof b) {
                            ...
                            if (!d && (null === e || e && e.length <= 1)) {
                                var f = a.match(/<br\s?\/?>/gi),
                                    g = a.match(/<img(.*?[^>])>/gi);
                                f || g || (this.clean.singleLine = !0, a = a.replace(/<\/?(p|div)(.*?)>/gi, ""))
                            }
                        }
                        return a
                    },
                    ...
                    savePreCode: function(a) {
                        return a = this.clean.savePreFormatting(a), a = this.clean.saveCodeFormatting(a)
                    },
                    ...
                    saveCodeFormatting: function(b) {
                        var c = b.match(/<code(.*?[^>])>(.*?)<\/code>/gi);
                        return null !== c && a.each(c, a.proxy(function(a, c) {
                            var d = c.match(/<code(.*?[^>])>(.*?)<\/code>/i);
            ...
            code: function() {
                return {
                    set: function(b) {
                        b = a.trim(b.toString()), b = this.clean.onSet(b), this.$editor.html(b), this.code.sync(), "" !== b && this.placeholder.remove(), setTimeout(a.proxy(this.buffer.add, this), 15), this.start === !1 && this.observe.load()
                    },
                    get: function() {
                        var a = this.$textarea.val();
                        return a = this.tabifier.get(a)
                    },
                    sync: function() {
                    ...
                    startSync: function() {
                        ...
                        this.code.syncCode && this.code.syncCode == a || (this.code.syncCode = a, a = this.core.setCallback("syncBefore", a), a = this.clean.onSync(a), this.$textarea.val(a), this.core.setCallback("sync", a), this.start === !1 && this.core.setCallback("change", a), this.start = !1, this.autosave.onChange())
                    },
                    toggle: function() {
                    ...
                    showCode: function() {
                        ...
                        var b = a(window).scrollTop(),
                            c = this.$editor.innerHeight();
                        this.$editor.hide();
                        var d = this.$textarea.val();
                        this.modified = this.clean.removeSpaces(d), d = this.tabifier.get(d), this.$textarea.val(d).height(c).show().focus(), this.$textarea.on("keydown.redactor-textarea-indenting", this.code.textareaIndenting), a(window).scrollTop(b), this.$textarea[0].setSelectionRange && this.$textarea[0].setSelectionRange(0, 0), this.$textarea[0].scrollTop = 0, this.opts.visual = !1, this.button.setInactiveInCode(), this.button.setActive("html"), this.core.setCallback("source", d)
                    },
                    showVisual: function() {
                        if (!this.opts.visual) {
                            var a = this.$textarea.hide().val();
                            this.modified !== this.clean.removeSpaces(a) && this.code.set(a), this.$editor.show(), this.utils.isEmpty(a) || this.placeholder.remove(), this.caret.setOffset(this.code.offset), this.$textarea.off("keydown.redactor-textarea-indenting"), this.button.setActiveInVisual(), this.button.setInactive("html"), this.observe.load(), this.opts.visual = !0, this.core.setCallback("visual", a)
                        }
                    },
            ...
            core: function() {
                return {
                    ...
                    setCallback: function(b, c, d) {
                        var e = this.opts[b + "Callback"];
                        return a.isFunction(e) ? "undefined" == typeof d ? e.call(this, c) : e.call(this, c, d) : "undefined" == typeof d ? c : d
                    },
                    destroy: function() {
                ...
                return {
                    build: function(b, c, d) {
                        "formatting" == b && this.opts.formattingAdd && a.each(this.opts.formattingAdd, a.proxy(function(a, b) {
                            var c = b.tag;
                            "undefined" != typeof b["class"] && (c = c + "-" + b["class"]), b.type = this.utils.isBlockTag(b.tag) ? "block" : "inline";
                            var e = "inline" == b.type ? "inline.formatting" : "block.formatting";
                            this.opts.linebreaks && "block" == b.type && "p" == b.tag || (this.formatting[c] = {
                                tag: b.tag,
                                style: b.style,
                                "class": b["class"],
                                attr: b.attr,
                            ...
                            "formatting" == b && g.addClass("redactor-formatting-" + d), g.on("click", a.proxy(function(a) {
                                a.preventDefault();
                                var b = "func",
                                    c = e.func;
                                e.command ? (b = "command", c = e.command) : e.dropdown && (b = "dropdown", c = e.dropdown), this.button.onClick(a, d, b, c), this.dropdown.hideAll()
                            }, this)), c.append(g)
                        }, this))
                    },
                    show: function(b, c) {
                        ...
                        if (this.utils.isMobile() && !this.utils.browser("msie") && document.activeElement.blur(), d.hasClass("dropact")) this.dropdown.hideAll();
                        else {
                        ...
                        a(document).one("click", a.proxy(this.dropdown.hide, this)), this.$editor.one("click", a.proxy(this.dropdown.hide, this));
                        var l = a(document.body),
                            m = l.width();
                        f.on("mouseover", function() {
                            l.addClass("body-redactor-hidden"), l.css("margin-right", l.width() - m + "px")
                        }), f.on("mouseout", function() {
                            l.removeClass("body-redactor-hidden").css("margin-right", 0)
                        }), b.stopPropagation()
                    },
                    hideAll: function() {
                        this.$toolbar.find("a.dropact").removeClass("redactor-act").removeClass("dropact"), a(document.body).removeClass("body-redactor-hidden").css("margin-right", 0), a("#redactor-dropdown-holder ul.dropdown-menu").hide(), this.core.setCallback("dropdownHide")
                    },
                    hide: function(b) {
                        var c = a(b.target);
                        c.hasClass("dropact") || (c.removeClass("dropact"), this.dropdown.hideAll())
                    }
                }
            },
            file: function() {
                ...
                return {
                    ...
                    setEnd: function() {
                        if (this.utils.browser("mozilla") || this.utils.browser("msie")) {
                            ...
                            this.$editor.focus(), this.caret.setEnd(a)
                        } else {
                            this.selection.get();
                            try {
                ...
                return {
                        ...
                        this.modal.load("image", this.lang.get("image"), 700), this.modal.createCancelButton(), this.image.buttonSave = this.modal.createActionButton(this.lang.get("save")), this.opts.concrete5.filemanager ? a("a[data-action=choose-image-from-file-manager]").on("click", function(b) {
                            b.preventDefault(), ConcreteFileManager.launchDialog(function(b) {
                                jQuery.fn.dialog.showLoader(), ConcreteFileManager.getFileDetails(b.fID, function(b) {
                                    jQuery.fn.dialog.hideLoader();
                                    var c = b.files[0];
                                    a("#redactor-image-link").val(c.urlDownload)
                                })
                            })
                    ...
                    showEdit: function(b) {
                        ...
                        if (this.image.$selectUrlOpen.on("change", function() {
                                ...
                                this.image.update(b)
                            }, this)), a("#redactor-image-title").val(b.attr("alt")), this.opts.imageLink) {
                    ...
                    update: function(b) {
                        ...
                        var c = b.closest("a");
                        b.attr("alt", a("#redactor-image-title").val()), this.image.setFloating(b);
                        var d = a.trim(a("#redactor-image-link").val());
                        if ("" !== d) {
                            var e = "((xn--)?[a-z0-9]+(-[a-z0-9]+)*\\.)+[a-z]{2,}",
                                f = new RegExp("^(http|ftp|https)://" + e, "i"),
                                g = new RegExp("^" + e, "i"); - 1 == d.search(f) && 0 === d.search(g) && this.opts.linkProtocol && (d = this.opts.linkProtocol + "://" + d);
                            var h, i, j, k = !1;
                            if ("blank" == a("#redactor-link-url-open").val() && (k = !0), "lightbox" == a("#redactor-link-url-open").val() && (h = a("#redactor-link-lightbox-type").val(), "iframe" == h && (i = a("#redactor-link-lightbox-iframe-width").val(), j = a("#redactor-link-lightbox-iframe-height").val())), 0 === c.length) {
                                var l = a('<a href="' + d + '">' + this.utils.getOuterHtml(b) + "</a>");
                                k && l.attr("target", "_blank"), h && (l.attr("data-concrete5-link-lightbox", h), "iframe" == h && i && j && (l.attr("data-concrete5-link-lightbox-width", i), l.attr("data-concrete5-link-lightbox-height", j))), b.replaceWith(l)
                            } else c.removeAttr("data-concrete5-link-lightbox"), c.removeAttr("data-concrete5-link-lightbox-width"), c.removeAttr("data-concrete5-link-lightbox-height"), c.attr("href", d), k ? c.attr("target", "_blank") : c.removeAttr("target"), h && (c.attr("data-concrete5-link-lightbox", h), "iframe" == h && i && j && (c.attr("data-concrete5-link-lightbox-width", i), c.attr("data-concrete5-link-lightbox-height", j)))
                        } else 0 !== c.length && c.replaceWith(this.utils.getOuterHtml(b));
                        this.modal.close(), this.observe.images(), this.code.sync()
                    },
                    setEditable: function(b) {
                        this.opts.imageEditable && b.on("dragstart", a.proxy(this.image.onDrag, this)), b.on("mousedown", a.proxy(this.image.hideResize, this)), b.on("click.redactor touchstart", a.proxy(function(c) {
                            return this.observe.image = b, 0 !== this.$editor.find("#redactor-image-box").length ? !1 : (this.image.resizer = this.image.loadEditableControls(b), a(document).on("click.redactor-image-resize-hide." + this.uuid, a.proxy(this.image.hideResize, this)), this.$editor.on("click.redactor-image-resize-hide." + this.uuid, a.proxy(this.image.hideResize, this)), void(this.opts.imageResizable && this.image.resizer.on("mousedown.redactor touchstart.redactor", a.proxy(function(a) {
                    ...
                    moveResize: function(a) {
                        ...
                        50 > b || 100 > c || (this.image.resizeHandle.el.width(c), this.image.resizeHandle.el.height(this.image.resizeHandle.el.width() / this.image.resizeHandle.ratio), this.code.sync())
                    },
                    stopResize: function() {
                    ...
                    hideResize: function(b) {
                        if (!b || 0 === a(b.target).closest("#redactor-image-box").length) {
                            if (b && "IMG" == b.target.tagName) {
                                var c = a(b.target);
                                c.attr("data-save-url", c.attr("src"))
                            }
                            var d = this.$editor.find("#redactor-image-box");
                            0 !== d.length && (this.opts.imageEditable && this.image.editter.remove(), a(this.image.resizer).remove(), d.find("img").css({
                                ...
                                }), a(document).off("click.redactor-image-resize-hide." + this.uuid),
                                this.$editor.off("click.redactor-image-resize-hide." + this.uuid), "undefined" != typeof this.image.resizeHandle && this.image.resizeHandle.el.attr("rel", this.image.resizeHandle.el.attr("style")), this.code.sync())
                        }
                    },
                    ...
                    remove: function(b) {
                        ...
                        var g;
                        0 !== e.length ? (g = e.next(), e.remove()) : 0 !== d.length ? (f = d.parent(), d.remove()) : c.remove(), a("#redactor-image-box").remove(), this.caret.setStart(0 !== e.length ? g : f), this.core.setCallback("imageDelete", c[0].src, c), this.modal.close(), this.code.sync()
                    },
                    insert: function(b, c, d) {
                        ...
                        g ? i.parent().contents().unwrap().wrap("<p />") : this.opts.linebreaks && i.before("<br>").after("<br>"), "string" != typeof b && this.core.setCallback("imageUpload", i, b)
                    }
                }
            },
            indent: function() {
                return {
                    ...
                    decreaseLists: function() {
                        ...
                        var b = this.selection.getCurrent(),
                            c = a(b).closest("li"),
                            d = c.parent();
                        0 !== c.length && 0 !== d.length && "LI" == d[0].tagName && d.after(c), this.indent.fixEmptyIndent(), this.opts.linebreaks || 0 !== c.length || (document.execCommand("formatblock", !1, "p"), this.$editor.find("ul, ol, blockquote, p").each(a.proxy(this.utils.removeEmpty, this))), this.clean.clearUnverified()
                    },
                ...
                return {
                    ...
                    format: function(a, b, c) {
                        if (!this.utils.isCurrentOrParent("PRE") && !this.utils.isCurrentOrParentHeader()) {
                            for (var d = ["b", "bold", "i", "italic", "underline", "strikethrough", "deleted", "superscript", "subscript"], e = ["strong", "strong", "em", "em", "u", "del", "del", "sup", "sub"], f = 0; f < d.length; f++) a == d[f] && (a = e[f]);
                            this.inline.type = b || !1, this.inline.value = c || !1, this.buffer.set(), this.utils.browser("msie") || this.$editor.focus(), this.selection.get(), this.range.collapsed ? this.inline.formatCollapsed(a) : this.inline.formatMultiple(a)
                        }
                    },
                    formatCollapsed: function(b) {
                        var c = this.selection.getCurrent(),
                            d = a(c).closest(b + "[data-redactor-tag=" + b + "]");
                    ...
                    formatMultiple: function(b) {
                        if (this.inline.formatConvert(b), this.selection.save(), document.execCommand("strikethrough"), this.$editor.find("strike").each(a.proxy(function(c, d) {
                                ...
                                var f;
                                if (this.inline.type ? (f = a("<span>").attr("data-redactor-tag", b).attr("data-verified", "redactor"), f = this.inline.setFormat(f)) : f = a("<" + b + ">").attr("data-redactor-tag", b).attr("data-verified", "redactor"), e.replaceWith(f.html(e.contents())), "span" == b) {
                                    var g = f.parent();
                                    if (g && "SPAN" == g[0].tagName && "style" == this.inline.type)
            ...
            insert: function() {
                return {
                    ...
                    ie11FixInserting: function(b, c) {
                        ...
                        var e = a(b).html();
                        e = "<p>" + e.replace(/<span class="redactor-ie-paste"><\/span>/gi, "</p>" + c + "<p>") + "</p>", a(b).replaceWith(e)
                    },
            ...
            keydown: function() {
                return {
                    init: function(b) {
                        if (!this.rtePaste) {
                            ...
                            if (this.opts.enterKey && (this.utils.browser("msie") || this.utils.browser("mozilla")) && (c === this.keyCode.DOWN || c === this.keyCode.RIGHT)) {
                                var f = !1,
                                    g = !1;
                                if (this.keydown.block && "TD" === this.keydown.block.tagName && (g = a(this.keydown.block).closest("table")), g && g.find("td").last()[0] === this.keydown.block && (f = !0), this.utils.isEndOfElement() && f) {
                            ...
                            if (c == this.keyCode.ENTER && !b.shiftKey && !b.ctrlKey && !b.metaKey) {
                                ...
                                if (this.opts.linebreaks && this.keydown.block) setTimeout(a.proxy(this.keydown.replaceDivToBreakLine, this), 1);
                                    ...
                                    if ("LI" !== this.keydown.block.tagName) setTimeout(a.proxy(this.keydown.replaceDivToParagraph, this), 1);
                                    else {
                                        j = this.selection.getCurrent();
                                        var l = a(j).closest("li"),
                                            m = l.closest("ul,ol");
                                        if (0 !== l.length && this.utils.isEmpty(l.html()) && 0 === m.next().length) {
                                            var h = a(this.opts.emptyHtml);
                            ...
                            if (c === this.keyCode.BACKSPACE || c === this.keyCode.DELETE) {
                                if (this.utils.browser("mozilla") && this.keydown.current && "TD" === this.keydown.current.tagName) return b.preventDefault(), !1;
                            ...
                            c === this.keyCode.BACKSPACE && (this.keydown.removeInvisibleSpace(), this.keydown.removeEmptyListInTable(b)), this.code.sync()
                        }
                    },
                    ...
                    onTab: function(a, b) {
                        ...
                        a.preventDefault();
                        var c;
                        return this.keydown.pre && !a.shiftKey ? (c = document.createTextNode(this.opts.preSpaces ? Array(this.opts.preSpaces + 1).join("Ã‚ ") : "	"), this.insert.node(c), this.code.sync()) : this.opts.tabAsSpaces !== !1 ? (c = document.createTextNode(Array(this.opts.tabAsSpaces + 1).join("Ã‚ ")), this.insert.node(c), this.code.sync()) : a.metaKey && 219 === b ? this.indent.decrease() : a.metaKey && 221 === b ? this.indent.increase() : a.shiftKey ? this.indent.decrease() : this.indent.increase(), !1
                    },
                    ...
                    replaceDivToParagraph: function() {
                        var b = this.selection.getBlock(),
                            c = b.innerHTML.replace(/<br\s?\/?>/gi, "");
                        if ("DIV" === b.tagName && "" === c && !a(b).hasClass("redactor-editor")) {
                    ...
                    insertBreakLineProcessing: function(b, c) {
                        ...
                        var d = document.createElement("br");
                        if (this.utils.browser("msie") ? (this.range.collapse(!1), this.range.setEnd(this.range.endContainer, this.range.endOffset)) : this.range.deleteContents(), this.range.insertNode(d), c === !0) {
                            var e = a(d).next();
                            if (0 !== e.length && "BR" === e[0].tagName && this.utils.isEndOfEditor()) return this.caret.setAfter(d), this.code.sync(), !1;
                            var f = document.createElement("br");
                            this.range.insertNode(f), this.caret.setAfter(f)
                        } else this.keydown.insertBreakLineProcessingAfter(d);
                        return this.code.sync(), !1
                    },
                    insertBreakLineProcessingAfter: function(b) {
                        var c = this.utils.createSpaceElement();
                        a(b).after(c), this.selection.selectElement(c), a(c).replaceWith(function() {
                            return a(this).contents()
                        })
                    },
                    ...
                    removeEmptyListInTable: function(b) {
                        var c = a(this.keydown.current),
                            ...
                            e = c.closest("td");
                        if (0 !== e.length && c.closest("li") && 1 === d.children("li").length) {
                ...
                return {
                    init: function(b) {
                        if (!this.rtePaste) {
                            ...
                            return e === !1 ? (b.preventDefault(), !1) : (!this.opts.linebreaks && 3 == this.keyup.current.nodeType && this.keyup.current.length <= 1 && (this.keyup.parent === !1 || "BODY" == this.keyup.parent.tagName) && this.keyup.replaceToParagraph(), !this.opts.linebreaks && this.utils.isRedactorParent(this.keyup.current) && "DIV" === this.keyup.current.tagName && this.keyup.replaceToParagraph(!1), this.opts.linebreaks || !a(this.keyup.parent).hasClass("redactor-invisible-space") || d !== !1 && "BODY" != d[0].tagName || (a(this.keyup.parent).contents().unwrap(), this.keyup.replaceToParagraph()), this.keyup.isLinkify(c) && (this.formatLinkify(this.opts.linkProtocol, this.opts.convertLinks, this.opts.convertUrlLinks, this.opts.convertImageLinks, this.opts.convertVideoLinks, this.opts.linkSize), this.observe.load(), this.code.sync()), c === this.keyCode.DELETE || c === this.keyCode.BACKSPACE ? (this.clean.clearUnverified(), this.observe.image ? (b.preventDefault(), this.image.hideResize(), this.buffer.set(), this.image.remove(this.observe.image), this.observe.image = !1, !1) : (this.$editor.find("p").each(a.proxy(this.utils.removeEmpty, this)), this.opts.linebreaks && this.keyup.current && "DIV" == this.keyup.current.tagName && this.utils.isEmpty(this.keyup.current.innerHTML) && (a(this.keyup.current).after(this.selection.getMarkerAsHtml()), this.selection.restore(), a(this.keyup.current).remove()), this.keyup.formatEmpty(b))) : void 0)
                        }
                    },
                    isLinkify: function(a) {
                        return this.opts.convertLinks && (this.opts.convertUrlLinks || this.opts.convertImageLinks || this.opts.convertVideoLinks) && a === this.keyCode.ENTER && !this.utils.isCurrentOrParent("PRE")
                    },
                    replaceToParagraph: function(b) {
                        var c, d = a(this.keyup.current);
                        c = a("<p>").append(b === !1 ? d.html() : d.clone()), d.replaceWith(c);
                        var e = a(c).next();
                        "undefined" != typeof e[0] && "BR" == e[0].tagName && e.remove(), this.caret.setEnd(c)
                    },
                    formatEmpty: function(b) {
                        var c = a.trim(this.$editor.html());
                        if (this.utils.isEmpty(c)) return b.preventDefault(), this.opts.linebreaks ? (this.$editor.html(this.selection.getMarkerAsHtml()), this.selection.restore()) : (c = "<p><br /></p>", this.$editor.html(c), this.focus.setStart()), this.code.sync(), !1
                    }
                }
            },
            lang: function() {
                ...
                return {
                    ...
                    setFocus: function() {
                        var b = this.$editor.find("#redactor-insert-line"),
                            c = a(b).next()[0];
                        c ? (this.caret.setAfter(b), b.remove()) : b.removeAttr("id")
                    }
                }
            },
            link: function() {
                return {
                    show: function(b) {
                        ...
                        this.link.$selectUrlOpen.on("change", function() {
                            "lightbox" == a(this).val() ? c.$selectUrlLightboxFieldGroup.show() : (c.$selectUrlLightboxFieldGroup.hide(), c.$selectUrlLightboxFieldGroupSelect.val("image").trigger("change"))
                            ...
                            "iframe" == a(this).val() ? c.$selectUrlLightboxIframeFieldGroup.show() : c.$selectUrlLightboxIframeFieldGroup.hide()
                    ...
                    cleanUrl: function() {
                        ...
                        if (this.link.url = this.link.url.replace(a, ""), this.link.url = this.link.url.replace(/^\/#/, "#"), this.link.url = this.link.url.replace("mailto:", ""), !this.opts.linkProtocol) {
                    ...
                    getData: function() {
                        this.link.$node = !1;
                        var b = a(this.selection.getCurrent()).closest("a");
                    ...
                    insert: function() {
                        ...
                        if (-1 != c.search("@") && /(http|ftp|https):\/\//i.test(c) === !1) c = "mailto:" + c;
                            ...
                            "blank" == a("#redactor-link-url-open").val() && (b = "_blank"),
                                "lightbox" == a("#redactor-link-url-open").val() && (e = a("#redactor-link-lightbox-type").val(), "iframe" == e && (f = a("#redactor-link-lightbox-iframe-width").val(), g = a("#redactor-link-lightbox-iframe-height").val()));
                    ...
                    set: function(b, c, d, e, f, g) {
                        if (b = a.trim(b.replace(/<|>/g, "")), this.selection.restore(), "" !== b || "" !== c) {
                            if ("" === b && "" !== c && (b = c), this.link.$node) this.buffer.set(), this.link.$node.text(b).attr("href", c), this.link.$node.removeAttr("data-concrete5-link-lightbox"), this.link.$node.removeAttr("data-concrete5-link-lightbox-width"), this.link.$node.removeAttr("data-concrete5-link-lightbox-height"), "" !== d ? this.link.$node.attr("target", d) : (this.link.$node.removeAttr("target"), e && (this.link.$node.attr("data-concrete5-link-lightbox", e), "iframe" == e && f && g && (this.link.$node.attr("data-concrete5-link-lightbox-width", f), this.link.$node.attr("data-concrete5-link-lightbox-height", g)))), this.code.sync();
                            else {
                                if (this.utils.browser("mozilla") && "" === this.link.text) {
                                    var h = a("<a />").attr("href", c).text(b);
                                    "" !== d && h.attr("target", d), this.insert.node(h), this.selection.selectElement(h)
                                } else {
                                    var h;
                                    this.utils.browser("msie") ? (h = a('<a href="' + c + '">').text(b), "" !== d && h.attr("target", d), h = a(this.insert.node(h)), this.selection.selectElement(h)) : (document.execCommand("createLink", !1, c), h = a(this.selection.getCurrent()).closest("a"), this.utils.browser("mozilla") && (h = a('a[_moz_dirty=""]')), "" !== d && h.attr("target", d), h.removeAttr("style").removeAttr("_moz_dirty"), ("" !== this.link.text || this.link.text != b) && (h.text(b), this.selection.selectElement(h)))
                                }
                                e && (h.attr("data-concrete5-link-lightbox", e), "iframe" == e && f && g && (h.attr("data-concrete5-link-lightbox-width", f), h.attr("data-concrete5-link-lightbox-height", g))), this.code.sync(), this.core.setCallback("insertedLink", h)
                            }
                    ...
                    unlink: function(b) {
                        ...
                        if (c) {
                            ...
                            for (var d = c.length, e = 0; d > e; e++) {
                                var f = a(c[e]).closest("a");
                                f.replaceWith(f.contents())
                            }
                            a(".redactor-link-tooltip").remove(), this.code.sync()
                        }
                    },
                    toggleClass: function(a) {
            ...
            list: function() {
                return {
                    toggle: function(b) {
                        ...
                        e ? this.utils.replaceToTag(d, "ol") : f ? this.utils.replaceToTag(d, "ul") : g ? this.list.remove(b) : this.list.insert(b), this.selection.restore(), this.code.sync()
                    },
                    insert: function(b) {
                        var c = this.selection.getParent(),
                        ...
                        var f = a(this.selection.getParent()).closest("ol, ul");
                        if (0 !== e.length) {
                            var g = e.prev(),
                                h = e.html();
                            e.html(""), !g || 1 !== g.length || "TD" !== g[0].tagName && "TH" !== g[0].tagName ? a(c).prepend(e) : a(g).after(e), e.html(h)
                        }
                        if (this.utils.isEmpty(f.find("li").text())) {
                            var i = f.children("li");
                            i.find("br").remove(), i.append(this.selection.getMarkerAsHtml())
                        }
                        if (f.length) {
                            var j = f.parent();
                            this.utils.isRedactorParent(j) && "LI" != j[0].tagName && this.utils.isBlock(j[0]) && j.replaceWith(j.contents())
                        }
                    ...
                    remove: function(b) {
                        document.execCommand("insert" + b);
                        var c = a(this.selection.getCurrent());
                        this.indent.fixEmptyIndent(), this.opts.linebreaks || 0 !== c.closest("li, th, td").length || (document.execCommand("formatblock", !1, "p"), this.$editor.find("ul, ol, blockquote").each(a.proxy(this.utils.removeEmpty, this)));
                        var d = a(this.selection.getCurrent()).closest("table"),
                            e = d.prev();
                        this.opts.linebreaks || 0 === d.length || 0 === e.length || "BR" != e[0].tagName || e.remove(), this.clean.clearUnverified()
                    }
                }
            },
            modal: function() {
                return {
                    ...
                    close: function(b) {
                        ...
                        this.$modalBox && (this.modal.disableEvents(), this.$modalOverlay.remove(), this.$modalBox.fadeOut("fast", a.proxy(function() {
                ...
                return {
                    ...
                    buttons: function(b, c) {
                        ...
                        a.each(this.opts.activeButtonsStates, a.proxy(function(b, c) {
                            var f = a(e).closest(b),
                                g = a(d).closest(b);
                            (0 === f.length || this.utils.isRedactorParent(f)) && this.utils.isRedactorParent(g) && (0 !== f.length || 0 !== g.closest(b).length) && this.button.setActive(c)
                        }, this));
                        var f = a(e).closest(this.opts.alignmentTags.toString().toLowerCase());
                    ...
                    images: function() {
                        this.$editor.find("img").each(a.proxy(function(b, c) {
                            var d = a(c);
                            d.closest("a").on("click", function(a) {
                                a.preventDefault()
                    ...
                    showTooltip: function(b) {
                        var c = a(b.target),
                            d = c.closest("a"),
                            e = 0 !== c.length ? c[0].tagName : !1;
                        if ("A" === d[0].tagName) {
                            if ("IMG" === e) return;
                            "A" !== e && (c = d)
                        }
                        if ("A" === e) {
                            var f = this.observe.getTooltipPosition(c),
                                g = a('<span class="redactor-link-tooltip"></span>'),
                                h = c.attr("href");
                            void 0 === h && (h = ""), h.length > 24 && (h = h.substring(0, 24) + "...");
                            var i = a('<a href="' + c.attr("href") + '" target="_blank" />').html(h).addClass("redactor-link-tooltip-action"),
                                j = a('<a href="#" />').html(this.lang.get("edit")).on("click", a.proxy(this.link.show, this)).addClass("redactor-link-tooltip-action"),
                                k = a('<a href="#" />').html(this.lang.get("unlink")).on("click", a.proxy(this.link.unlink, this)).addClass("redactor-link-tooltip-action");
                            g.append(i).append(" | ").append(j).append(" | ").append(k), g.css({
                                top: f.top + parseInt(c.css("line-height"), 10) + "px",
                                left: f.left + "px"
                            }), a(".redactor-link-tooltip").remove(), a("body").append(g)
                        }
                    },
                ...
                return {
                    init: function(b) {
                        return this.opts.cleanOnPaste ? (this.rtePaste = !0, this.buffer.set(), this.selection.save(), this.utils.saveScroll(), this.paste.createPasteBox(), a(window).on("scroll.redactor-freeze", a.proxy(function() {
                            ...
                            this.$pasteBox.remove(), this.selection.restore(), this.utils.restoreScroll(), this.paste.insert(b), a(window).off("scroll.redactor-freeze")
                    ...
                    createPasteBox: function() {
                        this.$pasteBox = a("<div>").html("").attr("contenteditable", "true").css({
                            ...
                            top: 0,
                            left: "-9999px"
                        }), this.utils.browser("msie") ? this.$box.append(this.$pasteBox) : a("body").append(this.$pasteBox), this.$pasteBox.focus()
                    },
                    insert: function(b) {
            ...
            placeholder: function() {
                return {
                    enable: function() {
                        this.placeholder.is() && (this.$editor.attr("placeholder", this.$element.attr("placeholder")), this.placeholder.toggle(), this.$editor.on("keyup.redactor-placeholder", a.proxy(this.placeholder.toggle, this)))
                    },
                    toggle: function() {
                        var a = "removeClass";
                        this.utils.isEmpty(this.$editor.html(), !1) && (a = "addClass"), this.$editor[a]("redactor-placeholder")
                    },
                    remove: function() {
                ...
                return {
                    ...
                    getNodes: function() {
                        ...
                        var b = this.selection.getNodesMarker(1),
                            ...
                            d = this.range.cloneRange();
                        if (this.range.collapsed === !1) {
                            var e = d.startContainer,
                                f = d.startOffset;
                            this.selection.setNodesMarker(d, c, !1), d.setStart(e, f), this.selection.setNodesMarker(d, b, !0)
                        } else this.selection.setNodesMarker(d, b, !0), c = b;
                        var g = [],
                            h = 0,
                            i = this;
                        this.$editor.find("*").each(function() {
                            if (this == b) {
                                var d = a(this).parent();
                                0 !== d.length && "BODY" != d[0].tagName && i.utils.isRedactorParent(d[0]) && g.push(d[0]), g.push(this), h = 1
                            } else h > 0 && (g.push(this), h += 1);
                            return this == c ? !1 : void 0
                        });
                        for (var j = [], k = g.length, l = 0; k > l; l++) "nodes-marker-1" != g[l].id && "nodes-marker-2" != g[l].id && j.push(g[l]);
                        return this.selection.removeNodesMarkers(), j
                    },
                    ...
                    restore: function() {
                        ...
                        0 !== a.length && 0 !== b.length ? this.caret.set(a, 0, b, 0) : 0 !== a.length ? this.caret.set(a, 0, a, 0) : this.$editor.focus(), this.selection.removeMarkers(), this.savedSel = !1
                    },
                    ...
                    replaceWithHtml: function(a) {
                        if (a = this.selection.getMarkerAsHtml(1) + a + this.selection.getMarkerAsHtml(2), this.selection.get(), window.getSelection && window.getSelection().getRangeAt) {
                            this.range.deleteContents();
                            var b = document.createElement("div");
                            b.innerHTML = a;
                            for (var c, d = document.createDocumentFragment(); c = b.firstChild;) d.appendChild(c);
                            this.range.insertNode(d)
                        } else document.selection && document.selection.createRange && this.range.pasteHTML(a);
                        this.selection.restore(), this.code.sync()
                    }
                }
            },
            ...
            tabifier: function() {
                return {
                    ...
                    cleanTag: function(a) {
                        ...
                        for (var d; d = /\s*([^= ]+)(?:=((['"']).*?\3|[^ ]+))?/.exec(a);) d[2] ? b += d[1].toLowerCase() + "=" + d[2] : d[1] && (b += d[1].toLowerCase()),
                            b += " ", a = a.substr(d[0].length);
            ...
            tidy: function() {
                return {
                    ...
                    replaceTags: function(b) {
                        ...
                        return this.tidy.$div.find(d.join(",")).each(a.proxy(function(b, c) {
                            var d = e[b];
                            a(c).replaceWith(function() {
                                for (var b = a("<" + d + " />").append(a(this).contents()), c = 0; c < this.attributes.length; c++) b.attr(this.attributes[c].name, this.attributes[c].value);
                                return b
                            })
                        }, this)), b
                    },
            ...
            toolbar: function() {
                return {
                    ...
                    build: function() {
                        this.toolbar.hideButtons(), this.toolbar.hideButtonsOnMobile(), this.toolbar.isButtonSourceNeeded(), 0 !== this.opts.buttons.length && (this.$toolbar = this.toolbar.createContainer(), this.toolbar.setOverflow(), this.toolbar.append(), this.toolbar.setFormattingTags(), this.toolbar.loadButtons(), this.toolbar.setFixed(), this.opts.activeButtons && this.$editor.on("mouseup.redactor keyup.redactor focus.redactor", a.proxy(this.observe.buttons, this)))
                    },
                    createContainer: function() {
                        return a("<ul>").addClass("redactor-toolbar").attr("id", "redactor-toolbar-" + this.uuid)
                    },
                    ...
                    observeScroll: function() {
                        var b = a(this.opts.toolbarFixedTarget).scrollTop(),
                            c = 1;
                        this.opts.toolbarFixedTarget === document && (c = this.$box.offset().top), b > c ? this.toolbar.observeScrollEnable(b, c) : this.toolbar.observeScrollDisable()
                    },
                    observeScrollEnable: function(a, b) {
                        var c = this.opts.toolbarFixedTopOffset + a - b,
                            d = 0,
                            e = b + this.$box.height() - 32,
                        ...
                        this.$toolbar.addClass("toolbar-fixed-box"), this.$toolbar.css({
                            ...
                            top: c + "px",
                            left: d
                        }), this.toolbar.setDropdownsFixed(), this.$toolbar.css("visibility", e > a ? "visible" : "hidden")
                    },
            ...
            upload: function() {
                return {
                    ...
                    sendData: function(b, c) {
                        ...
                        d.open("POST", this.upload.url), d.onreadystatechange = a.proxy(function() {
                            if (4 == d.readyState) {
        ...
        }), b.prototype.init.prototype = b.prototype, a.Redactor.fn.formatLinkify = function(b, c, f, g, h, i) {
            for (var j = "((?:http[s]?:\\/\\/(?:www\\.)?|www\\.){1}(?:[0-9A-Za-z\\-%_]+\\.)+[a-zA-Z]{2,}(?::[0-9]+)?(?:(?:/[0-9A-Za-z\\-#\\.%+_]*)+)?(?:\\?(?:[0-9A-Za-z\\-\\.%_]+(?:=[0-9A-Za-z\\-\\.%_\\+]*)?)?(?:&(?:[0-9A-Za-z\\-\\.%_]+(?:=[0-9A-Za-z\\-\\.%_\\+]*)?)?)*)?(?:#[0-9A-Za-z\\-\\.%_\\+=\\?&;]*)?)", k = new RegExp(j, "gi"), l = /(https?|ftp):\/\//i, m = new RegExp("(?:([^:/?#]+):)?(?://([^/?#]*))?([^?#]*\\.(?:jpg|gif|png))(?:\\?([^#]*))?(?:#(.*))?", "gi"), n = (this.$editor ? this.$editor[0] : this).childNodes, o = n.length; o--;) {
                var p = n[o];
                if (3 === p.nodeType && "PRE" !== p.parentNode) {
                    var q = p.nodeValue;
                    if (h && q) {
                        var r = '<iframe width="500" height="281" src="',
                            s = '" frameborder="0" allowfullscreen></iframe>';
                        q.match(d) ? (q = q.replace(d, r + "//www.youtube.com/embed/$1" + s), a(p).after(q).remove()) : q.match(e) && (q = q.replace(e, r + "//player.vimeo.com/video/$2" + s), a(p).after(q).remove())
                    }
                    if (g && q && q.match(m)) {
                        var t = q.match(m);
                        return q = q.replace(m, '<img src="' + t + '" />'), void a(p).after(q).remove()
                    } - 1 != q.search(/\$/g) && (q = q.replace(/\$/g, "&#36;"));
                    var t = q.match(k);
                    if (f && q && t) {
                        for (var u = t.length, v = 0; u > v; v++) {
                            null !== t[v].match(/\.$/) && (t[v] = t[v].replace(/\.$/, ""));
                            var w = t[v],
                                x = w,
                                y = "";
                            null !== w.match(/\s$/) && (y = " ");
                            var z = b + "://";
                            null !== w.match(l) && (z = ""), x.length > i && (x = x.substring(0, i) + "..."), x = x.replace(/&#36;/g, "$").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;");
                            var A = [],
                                B = q.match("<a(.*?)</a>");
                            if (null !== B) {
                                var u = B.length;
                                for (o = 0; u > o; o++) A[o] = B[o], q = q.replace(B[o], "{abuffer" + o + "}")
                            }
                            q = q.replace(w, '<a href="' + z + a.trim(w) + '">' + a.trim(x) + "</a>" + y), a.each(A, function(a, b) {
                                q = q.replace("{abuffer" + a + "}", b)
                            })
                        }
                        a(p).after(q).remove()
                    }
                } else 1 !== p.nodeType || /^(pre|a|button|textarea)$/i.test(p.tagName) || a.Redactor.fn.formatLinkify.call(p, b, c, f, g, h, i)
            }
        }
        ...
        RedactorPlugins.fontfamily = function() {
            return {
                init: function() {
                    ...
                    var e = this.button.add("fontfamily", "Change Font Family");
        ...
        RedactorPlugins.fontsize = function() {
            return {
                init: function() {
                    ...
                    var e = this.button.add("fontsize", "Change Font Size");
...
if (RedactorPlugins.underline = function() {
        return {
            init: function() {
                this.button.addAfter("italic", "underline", this.lang.get("underline")), $btn = this.button.get("underline"), this.button.addCallback($btn, this.underline.format),
